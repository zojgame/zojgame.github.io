import{lo as Ie,fR as Ue,lp as ae,ex as $e,gy as ke,Y as q,lq as Le,lr as Ne,ls as He,ik as qe,lt as Ge,lu as Ve,eA as x,aj as We,aC as Pe,M as Ce,eN as je,bT as K,ez as Z,fm as Y,ka as Ke,eF as oe,eG as Ye,eD as Xe,lv as Je,lc as Qe,eI as le,hp as Ze,jS as et,lw as tt,lx as it,s as rt,jU as de,ly as st,lz as nt,_ as ue,jV as at,J as ot,eu as lt,D as X,P as dt,au as he,cC as ut,lA as ht,ar as ce}from"./index-b5c8f851.js";import{c as ct}from"./ExpandedCIM-0020ab0e.js";import{t as _t,b as ft,o as _e,h as mt,i as pt}from"./Container-f991c035.js";import{i as gt}from"./BufferPool-f0e47fc2.js";import{T as B,E as S,S as $}from"./color-0916c686.js";import{g as vt,a as L,h as G,w as A,d as bt,m as xt}from"./WGLContainer-21aabd6b.js";import{L as E}from"./enums-fb086c25.js";import{e as wt,a as W,f as ee}from"./ProgramTemplate-a9187eb2.js";import{n as U}from"./programUtils-90c90c70.js";import{e as fe,r as yt,t as Tt,a as Ft,m as Bt,J as Et,n as Ot,b as Rt,c as Mt}from"./MagnifierPrograms-9f54c6e2.js";import{d as es,y as ts}from"./MagnifierPrograms-9f54c6e2.js";import{h as te,E as C,a as ie,i as Pt}from"./FramebufferObject-4be671ef.js";import{R as v,E as H,F as re,O as j,I as J,L as D,C as me,D as O,B as se,G as T,U as ne,P as Ct}from"./enums-bdecffa2.js";import{o as pe,N as St}from"./RenderingContext-7cd1863e.js";import{z as At,q as Dt,Q as zt,E as It,F as Ut,L as N,M as $t,_ as Se,R as ge}from"./definitions-1467ba4a.js";import{t as ve}from"./VertexElementDescriptor-2925c6af.js";import{e as R,T as k}from"./Texture-507d5ea8.js";import{r as rs}from"./GraphicsView2D-dbec6ccd.js";import{i as ns}from"./GraphicContainer-ea339e88.js";import{t as be}from"./requestImageUtils-5dd6ae31.js";import"./BidiEngine-9a40f2f4.js";import"./visualVariablesUtils-f4ae79f2.js";import"./OptimizedGeometry-d94e541f.js";import"./GeometryUtils-984e8446.js";import"./enums-f1a6a48a.js";import"./utils-ebbcf3da.js";import"./GeometryUtils-7a7937c3.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-50e37a76.js";import"./floatRGBA-ba8d5dad.js";import"./AttributeStoreView-b12ba31a.js";import"./TiledDisplayObject-a2315f25.js";import"./util-a6af6461.js";import"./StyleDefinition-29c49b98.js";import"./config-1337d16e.js";import"./earcut-d423749e.js";import"./featureConversionUtils-6aca8295.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./rasterizingUtils-99212870.js";import"./pbf-eb90fa42.js";import"./imageutils-c59aa434.js";import"./Matcher-dd0694f8.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-f7b8bf8b.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-eac2b0ee.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-07f34ef9.js";import"./TimeOnly-99f1af45.js";import"./OrderIndependentTransparency-6ae10952.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./projectionSupport-d15822a5.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-838acb73.js";import"./FeatureContainer-090d46c9.js";import"./TileContainer-1c596b67.js";import"./vec3f32-2da9db36.js";let kt=class{constructor(){this._resourceMap=new Map,this._inFlightResourceMap=new Map,this.geometryEngine=null,this.geometryEnginePromise=null}destroy(){this._inFlightResourceMap.clear(),this._resourceMap.clear()}getResource(e){return this._resourceMap.get(e)??null}async fetchResource(e,t){const i=this._resourceMap.get(e);if(i)return{width:i.width,height:i.height};let r=this._inFlightResourceMap.get(e);return r?r.then(n=>({width:n.width,height:n.height})):(r=Ie(e,t),this._inFlightResourceMap.set(e,r),r.then(n=>(this._inFlightResourceMap.delete(e),this._resourceMap.set(e,n),{width:n.width,height:n.height}),()=>({width:0,height:0})))}deleteResource(e){this._inFlightResourceMap.delete(e),this._resourceMap.delete(e)}loadFont(e){return ct(e)}},Lt=class{constructor(e){this.events=new Ue,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=$e([ke(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),h=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ve();return Le(f),Ne(f,f,[m,m]),He(f,f,qe(g)),Ge(f,f,[h,_]),f}};const Nt={background:{"background.frag":`#ifdef PATTERN
